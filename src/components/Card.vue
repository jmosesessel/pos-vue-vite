    ...
    <div class="flex gap-6">
        ...
        class="flex flex-col p-4 w-1/3 bg-red-900 rounded-lg gap-y-3">
            <div class="flex items-center gap-x-3">
                ...
                <span class="text-xs font-medium" :class="stat.status === 'up' ? 'text-accent-green' : 'text-accent-orange'">
                    {{stat.percentage}}
                </span>
                <div class="p-0.5 rounded-full" :class="stat.status === 'up' ? 'bg-accent-green/20' : 'bg-accent-orange/20'">
